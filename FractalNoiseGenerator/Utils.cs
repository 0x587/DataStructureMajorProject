...
public partial class FractalNoiseGenerator
{
    ...
    private Int32 Hash(Int32 seed, Int32 x, Int32 y)
    {
    ...
    private double Pseudorandom(Int32 seed, Int32 x, Int32 y)
    {
    ...
    private double CubicInterpolation(double a, double b, double c, double d, double t)
    {
        double p = (d - c) - (a - b);
